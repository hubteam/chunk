...
public class ChunkAnalysisBeamSearch<T> implements ChunkAnalysisSequenceClassificationModel<T> {
	 ...
	 * @return 最好的序列
	 */
	public Sequence bestSequence(T[] arg0, T[] arg1, Object[] arg3, BeamSearchChunkAnalysisContextGenerator<T> arg4,
			ChunkAnalysisSequenceValidator<T> arg5) {
	...
	public Sequence[] bestSequences(int numSequences, T[] sequence, T[] pos, Object[] additionalContext, double minSequenceScore,
			BeamSearchChunkAnalysisContextGenerator<T> cg, ChunkAnalysisSequenceValidator<T> validator) {
	 ...
	 * @return
	 */
	public Sequence[] bestSequences(int arg0, T[] arg1, T[] arg2, Object[] arg4, BeamSearchChunkAnalysisContextGenerator<T> arg5,
